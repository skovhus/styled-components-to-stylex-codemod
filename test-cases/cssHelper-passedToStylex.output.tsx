...
function Container(props: Pick<React.ComponentProps<"div">, "children">) {
  return (
    <div
...
function FadeBox(props: Pick<React.ComponentProps<"div">, "children">) {
  return <div {...stylex.props(scrollFadeMaskStyles(24, "bottom"))}>{props.children}</div>;
}

// Pattern 3: Multiple css helpers
function ComplexFade(props: Pick<React.ComponentProps<"div">, "children">) {
  return (
    <div
      {...stylex.props(
        styles.complexFade,
...
function OverrideDisplay(props: Pick<React.ComponentProps<"div">, "children">) {
  return (
    <div
