...
function OverrideButton(props: React.PropsWithChildren<{ style?: React.CSSProperties }>) {
...
function MixedStyles(props: React.PropsWithChildren<{ style?: React.CSSProperties }>) {
  const { children, style } = props;
