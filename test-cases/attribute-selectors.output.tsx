...
type InputProps = Omit<React.InputHTMLAttributes<HTMLInputElement>, "style" | "className">;
...
type LinkProps = Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, "style" | "className">;
