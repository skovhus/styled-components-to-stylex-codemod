...
type HelpTextProps = Omit<React.ComponentPropsWithRef<typeof Text>, "style" | "className">;
...
type SeparatorProps = Omit<React.ComponentPropsWithRef<typeof Text>, "style" | "className">;
