    ...
    <Component
      ...
      {...mergedSx(
        [
          ...
          overflowHidden && styles.flexOverflowHidden,
          noMinWidth && styles.flexNoMinWidth,
          noMinHeight && styles.flexNoMinHeight,
...
export const App = () => (
  <div style={{ display: "flex", flexDirection: "column", gap: 12, padding: 16 }}>
    ...
    <Flex onContextMenu={(e) => e.stopPropagation()} sx={styles.padded}>
      Padded content
    </Flex>
