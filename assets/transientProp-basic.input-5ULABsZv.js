import"./chunk-jRWAZmH_.js";import{c as e,m as t,p as n}from"./index-BoKTTZFH.js";import{t as r}from"./icon-WtD8YpyU.js";var i=n();t();var a=e.div`
  color: red;
  cursor: ${e=>e.$draggable?`move`:`pointer`};
`,o=e(({className:e,text:t,...n})=>(0,i.jsx)(`a`,{...n,className:e,children:t}))`
...
`;function m(e){let{children:t,...n}=e;return(0,i.jsx)(p,{...n,$open:!!t,$duration:350,children:t})}function h(e){let{children:t,...n}=e;return(0,i.jsx)(p,{$open:!!t,$duration:350,...n,children:t})}var g=e.div`
  ...
  left: 0;
  z-index: ${e=>e.$zIndex};
`;function _(){return(0,i.jsx)(g,{$zIndex:1,onClick:()=>{},children:`hello`})}var v=e.div`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
