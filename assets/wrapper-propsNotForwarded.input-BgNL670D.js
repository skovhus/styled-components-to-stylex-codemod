import{j as e,c as h}from"./index-Dk_YuQVl.js";function r({selected:d,highlighted:t,children:i,...l}){return e.jsxs("div",{...l,children:[d&&e.jsx("span",{children:"★"}),e.jsx("span",{style:{opacity:t?.7:1},children:i})]})}const s=h(r)`
  padding: 8px 12px;
  border-radius: 4px;
  background: #f0f0f0;
