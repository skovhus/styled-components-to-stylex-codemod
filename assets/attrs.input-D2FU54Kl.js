import"./chunk-jRWAZmH_.js";import{c as e,m as t,p as n}from"./index-DOtSvtsV.js";t();var r=n(),i=e=>{let{column:t,center:n,focusIndex:i,...a}=e;return(0,r.jsx)(`div`,{"data-focus-index":i,...a})},a=e.input.attrs(e=>({type:`text`,size:e.$small?5:void 0}))`
  border-radius: 3px;
...
`,o=e(`input`).attrs(e=>({"data-1p-ignore":e.allowPMAutofill!==!0}))`
  height: 32px;
  padding: 8px;
  background: white;
`,s=e(i).attrs({column:!0,center:!0})`
  position: absolute;
  top: 0;
  bottom: 0;
  opacity: ${e=>+!e.loaded};
`,c=e(i).attrs(e=>({tabIndex:e.tabIndex??0}))`
  overflow-y: auto;
  position: relative;
`,l=e(i).attrs(e=>({tabIndex:e.tabIndex??0}))`
  overflow-y: auto;
  position: relative;
  flex-grow: 1;
`,u=e(i).attrs(e=>({tabIndex:e.focusIndex??0}))`
  overflow-y: auto;
`,d=e.div.attrs(e=>({tabIndex:e.tabIndex??0}))`
  overflow: auto;
`,f=e(i).attrs(e=>({column:e.column??!0}))`
  align-items: center;
`,p=e.span.attrs({style:{whiteSpace:`nowrap`}})`
  color: blue;
`,m=e.div.attrs(({$height:e})=>({style:{height:e?`${e}px`:void 0}}))`
  display: flex;
  align-items: center;
