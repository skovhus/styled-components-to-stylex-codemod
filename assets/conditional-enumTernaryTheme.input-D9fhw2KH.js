import{j as r,c as i}from"./index-0Tf7FkTE.js";var n=(e=>(e.primary="primary",e.gradient="gradient",e.success="success",e.warning="warning",e.error="error",e))(n||{});const t=i.div`
  height: 40px;
  padding: 8px 16px;
