import{c as e,f as t,p as n}from"./index-DTT2cnJb.js";var r=n(),i=e.button.withConfig({shouldForwardProp:e=>![`color`,`size`].includes(e)})`
  ...
  border: none;
  border-radius: 4px;
`,a=e.a.withConfig({shouldForwardProp:e=>t(e)&&e!==`isActive`})`
...
`,o=e.div.withConfig({shouldForwardProp:e=>!e.startsWith(`$`)})`
...
`,s=e.div`
  ...
  padding: 16px;
`,c=e.div.withConfig({shouldForwardProp:e=>![`variant`,`elevation`,`rounded`].includes(e)})`
