import"./chunk-jRWAZmH_.js";import{c as e,m as t,p as n}from"./index-DwfImnim.js";t();var r=n();function i(e){let{children:t,className:n,style:i,...a}=e;return(0,r.jsx)(`section`,{...a,className:n,style:i,children:t})}var a=e(i)`
  display: grid;
  grid-template-columns: repeat(${e=>e.$columnCount??1}, minmax(0, 1fr));
  top: ${e=>e.$floatingOffset??0}px;
  padding: ${e=>e.$asCard?`16px`:`8px`};
  background-color: #eef2ff;
`,o=e(a).attrs({$asCard:!0,$floatingOffset:4})`
  border-radius: 8px;
