import{j as e,d as t,l as d}from"./index-BtEqQ3JB.js";const s=t.div`
  position: absolute;
  ${n=>n.$zIndex!==void 0&&`z-index: ${n.$zIndex};`}
`,o=t.img`
  width: 100px;
  ${({$isBw:n})=>n&&d`filter: grayscale(100%);`}
`,i=t.p`
  font-size: 14px;
  ${n=>n.$renderingContext==="dialog"&&n.$lines===1&&d`background-color: hotpink;`}
