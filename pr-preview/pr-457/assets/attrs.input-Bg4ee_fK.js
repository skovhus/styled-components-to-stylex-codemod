import"./chunk-jRWAZmH_.js";import{c as e,m as t,p as n}from"./index-pB-WyW-a.js";import{l as r}from"./helpers-F-qFSGrg.js";t();var i=n(),a=e=>{let{column:t,center:n,focusIndex:r,...a}=e;return(0,i.jsx)(`div`,{"data-focus-index":r,...a})},o=e.input.attrs(e=>({type:`text`,size:e.$small?5:void 0}))`
  border-radius: 3px;
...
`,v=e.div.attrs(e=>({style:{height:e.height??`16px`}}))`
  display: flex;
  align-items: center;
  padding: 4px;
  background-color: #fef3c7;
`,y=e.div.attrs(e=>({style:{height:e.$height??1}}))`
  width: 100%;
  background-color: #94a3b8;
`,b=e.div.attrs(({$height:e})=>({style:{height:e?`${e}px`:`16px`}}))`
  width: 100%;
  background-color: #16a34a;
`;function x(e){let{className:t,height:n,style:r}=e;return(0,i.jsx)(y,{$height:n,className:t,style:r})}function S(e){let{children:t,className:n,size:r,style:a,variant:o}=e;return(0,i.jsx)(`button`,{className:n,"data-size":r,"data-variant":o,style:a,children:t})}var C=e(e(S).attrs({size:`small`,variant:`borderless`})`
  padding: 4px 8px;
`)`
  color: #4338ca;
  background-color: #e0e7ff;
`,w=e.span.attrs({style:{color:`#0f766e`}})`
  font-weight: 600;
`,T=`#7c3aed`,E=e.span.attrs(()=>({style:{color:T}}))`
  font-style: italic;
