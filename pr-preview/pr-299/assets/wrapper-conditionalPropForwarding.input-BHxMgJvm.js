import{j as e,c as d}from"./index-n-d7C2lh.js";function h(t){const{label:i,compact:a,highlighted:s,className:c,style:o}=t;return e.jsx("div",{className:c,style:o,children:e.jsx("span",{style:{fontWeight:s?"bold":"normal"},children:a?i.slice(0,3):i})})}const l=d(h)`
