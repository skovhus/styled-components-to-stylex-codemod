import{t as e}from"./jsx-runtime-B8sTdNyf.js";import{c as t,f as n}from"./index-DJNypLUg.js";var r=e(),i=t.button.withConfig({shouldForwardProp:e=>![`color`,`size`].includes(e)})`
  ...
  border: none;
  border-radius: 4px;
`,a=t.a.withConfig({shouldForwardProp:e=>n(e)&&e!==`isActive`})`
...
`,o=t.div.withConfig({shouldForwardProp:e=>!e.startsWith(`$`)})`
...
`,s=t.div`
  ...
  padding: 16px;
`,c=t.div.withConfig({shouldForwardProp:e=>![`variant`,`elevation`,`rounded`].includes(e)})`
