import"./chunk-jRWAZmH_.js";import{c as e,m as t,p as n}from"./index-FoycHDhT.js";import{n as r,t as i}from"./action-menu-divider-_iCP1r03.js";t();var a=n(),o=e.div`
  padding: 8px 12px;
  display: flex;
  align-items: center;
`;o.HEIGHT=42,o.PADDING=8;var s=e.button`
  padding: 8px 16px;
  background: gray;
`;s.HEIGHT=36;var c=e(s)`
  background: blue;
  color: white;
`;c.HEIGHT=s.HEIGHT;var l=e(r)`
  padding-left: 20px;
`,u=e(i)`
  padding-inline: 14px;
