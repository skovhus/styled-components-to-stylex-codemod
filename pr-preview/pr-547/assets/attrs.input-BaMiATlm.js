...
`;function Q(e){let{className:t,initial:n,animate:r,transition:i,keyframes:a,tabIndex:s,children:c}=e;return(0,o.jsx)(`div`,{className:t,"data-initial":n,"data-animate":r,"data-duration":i?.duration,"data-keyframes":a?.join(`,`),tabIndex:s,children:c})}var $=n(Q).attrs({initial:`hidden`,animate:`visible`,transition:{duration:.2},keyframes:[0,.5,1]})`
  padding: 8px;
