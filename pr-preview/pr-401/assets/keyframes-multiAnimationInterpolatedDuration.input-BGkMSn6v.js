import"./chunk-jRWAZmH_.js";import{f as e,o as t,p as n,u as r}from"./index-DimFOxuE.js";n();var i=e(),a=t`
  from {
    opacity: 0;
  }
  to {
...
`,s=r.div`
  animation:
    ${a} ${e=>e.$duration??200}ms ease,
    ${o} ${e=>e.$duration??1e3}ms linear;
  padding: 20px;
  background: white;
