import{t as e}from"./jsx-runtime-B8sTdNyf.js";import{c as t,p as n}from"./index-DjVMAuNG.js";import{c as r}from"./helpers-D-C853vr.js";n();var i=e(),a=e=>{let{column:t,color:n,gap:r,variant:a,...o}=e;return(0,i.jsx)(`span`,{"data-column":t,"data-color":n,"data-gap":r,"data-variant":a,...o})},o=t.div`
  color: red;
  font-size: 12px;
...
`,_=t.div`
  ...
  ${e=>e.$add?`
      color: red;
      ${e.$hasSubtitle?`border-width: 1px;`:`border-width: 2px;`}
    `:``}
`,v=t.div.withConfig({shouldForwardProp:e=>!e.startsWith(`$`)})`
  padding: 8px;
  width: ${e=>e.$add}px;
  height: ${e=>e.$add}px;
  ${e=>e.$add?`
