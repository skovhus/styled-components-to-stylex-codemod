import{t as e}from"./jsx-runtime-B8sTdNyf.js";import{l as t,p as n}from"./index-BRmF12AB.js";import{t as r}from"./icon-CsYR-0l8.js";var i=e();n();var a=t.div`
  color: red;
  cursor: ${e=>e.$draggable?`move`:`pointer`};
`,o=t(({className:e,text:t,...n})=>(0,i.jsx)(`a`,{...n,className:e,children:t}))`
...
`;function m(e){let{children:t,...n}=e;return(0,i.jsx)(p,{...n,$open:!!t,$duration:350,children:t})}function h(e){let{children:t,...n}=e;return(0,i.jsx)(p,{$open:!!t,$duration:350,...n,children:t})}var g=t.div`
  ...
  left: 0;
  z-index: ${e=>e.$zIndex};
`;function _(){return(0,i.jsx)(g,{$zIndex:1,onClick:()=>{},children:`hello`})}var v=t.div`
  position: fixed;
  top: 0;
  right: 0;
  bottom: 0;
