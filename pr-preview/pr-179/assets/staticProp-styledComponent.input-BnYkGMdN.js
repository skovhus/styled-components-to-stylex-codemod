import{j as e,a as r}from"./index-Cev5G7if.js";const a=i=>e.jsx("div",{className:i.className,children:i.children});a.Option=i=>e.jsx("div",{"data-value":i.value,children:i.children});a.Group=i=>e.jsx("div",{"data-label":i.label,children:i.children});a.Separator=()=>e.jsx("hr",{});const l=r(a)`
  width: 240px;
  min-height: 140px;
  padding-block: 12px;
  padding-inline: 12px;
