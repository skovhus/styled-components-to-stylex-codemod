import{t as e}from"./jsx-runtime-B8sTdNyf.js";import{l as t,p as n}from"./index-D5g-52M0.js";import{C as r,p as i,y as a}from"./helpers-BMbiwt5Y.js";n();var o=e=>t=>t.theme.color[e],s=e(),c=t.div`
  width: 160px;
  height: 20px;
  border-radius: 6px;
...
`,h=t.div`
  width: ${e=>e.$base+e.$extra}px !important;
  min-height: 40px;
  border-radius: 6px;
  background-color: #e2e8f0;
`,g=t.div`
...
`,b=()=>{let e=`accent`;return(0,s.jsxs)(`div`,{style:{display:`grid`,gap:8,padding:12},children:[(0,s.jsx)(c,{$highlightColor:`accent`}),(0,s.jsx)(l,{$highlightColor:e}),(0,s.jsx)(u,{$shimmerColor:e}),(0,s.jsx)(d,{$shimmerColor:e}),(0,s.jsx)(f,{$startColor:`labelBase`,$endColor:`accent`}),(0,s.jsx)(p,{$highlightColor:`accent`}),(0,s.jsx)(m,{children:`Default faint panel`}),(0,s.jsx)(m,{$color:`accent`,children:`Accent panel`}),(0,s.jsx)(h,{$base:50,$extra:30,children:`Important width panel`}),(0,s.jsx)(h,{$base:90,$extra:30,children:`Wider important width panel`}),(0,s.jsx)(g,{children:`Static helper panel`}),(0,s.jsx)(_,{$highlightColor:`accent`,$size:12}),(0,s.jsx)(v,{$shadow:`dark`}),(0,s.jsx)(y,{$shadowTone:`light`})]})};export{b as App};