import"./chunk-zsgVPwQN.js";import{t as e}from"./react-D4cBbUL-.js";import{f as t,s as n}from"./index-Dc2JEB1J.js";e();var r=t(),i=n.input`
  font-size: 14px;
...
`,a=({hasRange:e})=>(0,r.jsx)(i,{style:{width:e?48:`100%`,cursor:e?`text`:`ew-resize`,textAlign:e?`right`:`left`},defaultValue:e?`hasRange`:`no range`}),o=n.div`
  padding: 8px;
`,s=()=>Math.random()>.5,c=()=>(0,r.jsx)(o,{style:{width:s()?48:96,color:s()?`red`:`blue`},children:`random`}),l=n.div`
  padding: 4px;
`,u=n.div`
  background: yellow;
