import{j as e,a as t,b as r}from"./index-C-ToNHUY.js";const s=t.div`
  position: absolute;
  ${n=>n.$zIndex!==void 0&&`z-index: ${n.$zIndex};`}
`,o=t.img`
  width: 100px;
  ${({$isBw:n})=>n&&r`filter: grayscale(100%);`}
`,i=t.p`
  font-size: 14px;
  ${n=>n.$renderingContext==="dialog"&&n.$lines===1&&r`background-color: hotpink;`}
