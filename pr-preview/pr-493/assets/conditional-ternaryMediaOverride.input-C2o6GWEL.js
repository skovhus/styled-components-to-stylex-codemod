import{t as e}from"./jsx-runtime-B8sTdNyf.js";import{c as t}from"./index-d0vHVr80.js";import{b as n,u as r}from"./helpers-Dat6B8Yx.js";var i=e(),a=t.div`
  font-size: ${e=>e.$size===`large`?r(`large`):r(`small`)};
  ${n.phone} {
    font-size: ${e=>e.$size===`large`?r(`medium`):r(`small`)};
  }
  font-weight: 500;
  color: #333;
`,o=t.label`
