import{s as e,t}from"./jsx-runtime-B8sTdNyf.js";import{c as n,p as r}from"./index-9ve_m-XL.js";var i=e(r(),1),a=t(),o=n.h1`
  font-size: 1.5em;
  text-align: center;
  color: #bf4f74;
`,s=n.section`
...
`,c=n.select`
  ...
  border-radius: 4px;
  font-size: 13px;
`;function l(e){return(0,a.jsx)(`a`,{href:e.to,children:e.children})}var u=n.span`
  position: relative;
`,d=n.span`
  color: rebeccapurple;
