import{j as i,c as r}from"./index-iAVLmBIC.js";function n(e){const{column:c,gap:l,className:s,style:t,children:o}=e;return i.jsx("div",{className:s,style:{display:"flex",flexDirection:c?"column":"row",gap:l,...t},children:o})}const d=r(n)`
  overflow-y: auto;
