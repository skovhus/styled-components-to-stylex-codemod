import{f as e,s as t}from"./index-BPcf-hag.js";var n=e(),r=t(`span`).withConfig({shouldForwardProp:e=>![`align`,`selectable`].includes(e)}).attrs(e=>({align:e.align??`left`,selectable:e.selectable??!1}))`
  font-style: normal;
