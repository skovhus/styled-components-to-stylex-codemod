import{j as e,c as o}from"./index-FP_Cx-M0.js";const l=t=>{const{column:u,center:b,focusIndex:n,...r}=t;return e.jsx("div",{"data-focus-index":n,...r})},a=o.input.attrs(t=>({type:"text",size:t.$small?5:void 0}))`
  border-radius: 3px;
...
`,s=o("input").attrs(t=>({"data-1p-ignore":t.allowPMAutofill!==!0}))`
  ...
  padding: 8px;
  background: white;
`,d=o(l).attrs({column:!0,center:!0})`
  position: absolute;
  top: 0;
  bottom: 0;
  opacity: ${t=>t.loaded?0:1};
`,c=o(l).attrs(t=>({tabIndex:t.tabIndex??0}))`
  overflow-y: auto;
  position: relative;
