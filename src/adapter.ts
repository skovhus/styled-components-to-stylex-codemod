...
/** Fixed type name emitted for the polymorphic helper. */
export const POLYMORPHIC_TYPE_NAME = "PolymorphicComponentProps";

/** Content of the auto-generated polymorphic helper file. */
export const POLYMORPHIC_HELPER_CONTENT = `\
 ...
 */
export type ${POLYMORPHIC_TYPE_NAME}<
