...
export type WarningType =
  ...
  | "Adapter returned an unparseable value expression"
  | "Adapter returned undefined for helper call"
  | "Adapter returned undefined for imported value"
  ...
  | "Arrow function: helper call could not be resolved by adapter"
