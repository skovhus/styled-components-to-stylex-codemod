...
import { createCssHelperResolver, type ConditionalVariant } from "./css-helper.js";
...
import { buildPseudoMediaPropValue, invertWhen } from "./helpers.js";
import {
  addStyleKeyMixin,
...
import { createScopeHelpers } from "./scope-helpers.js";
import type { DescendantOverride, ExpressionKind } from "./shared.js";
...
export function lowerRules(args: {
  ...
  const {
    getRootIdentifierInfo,
    resolveImportInScope,
    resolveImportForExpr,
    buildSafeIndexedParamName,
  } = createScopeHelpers({ root, j, importMap });
