...
function fixtureResolveValue(ctx: ResolveValueContext): ResolveValueResult | null {
  if (ctx.kind === "theme") {
...
function fixtureResolveCall(ctx: CallResolveContext): CallResolveResult | null {
...
export const fixtureAdapter = defineAdapter({
  ...
  resolveValue: fixtureResolveValue,
  resolveCall: fixtureResolveCall,
});
